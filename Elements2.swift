...
public class Elements2 : NSObject {
    ...
    @objc dynamic public class func drawCanvas2(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 320, height: 568), resizing: ResizingBehavior = .aspectFit, fCD333: UIColor = UIColor(red: 0.988, green: 0.827, blue: 0.200, alpha: 1.000)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Dashboard Heading Drawing
        let dashboardHeadingPath = UIBezierPath()
        dashboardHeadingPath.move(to: CGPoint(x: 0.5, y: 0.5))
        dashboardHeadingPath.addLine(to: CGPoint(x: 0, y: 141))
        dashboardHeadingPath.addLine(to: CGPoint(x: 320, y: 90.58))
        dashboardHeadingPath.addLine(to: CGPoint(x: 320, y: 0))
        dashboardHeadingPath.addLine(to: CGPoint(x: -0.5, y: 0.5))
        fCD333.setFill()
        dashboardHeadingPath.fill()
        fCD333.setStroke()
        dashboardHeadingPath.lineWidth = 1
        dashboardHeadingPath.stroke()


        //// Notebook Info Drawing
        let notebookInfoPath = UIBezierPath(roundedRect: CGRect(x: 23.5, y: 222.5, width: 272, height: 91), cornerRadius: 10)
        UIColor.white.setFill()
        notebookInfoPath.fill()
        fCD333.setStroke()
        notebookInfoPath.lineWidth = 1
        notebookInfoPath.stroke()
    ...
    @objc(Elements2ResizingBehavior)
